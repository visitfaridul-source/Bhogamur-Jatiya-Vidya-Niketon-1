              ...
              >
                ...
                <form onSubmit={handleAuth} className="space-y-6">
                  ...
                  <div className="space-y-1 text-left">
                    ...
                    <input 
                      type="text" 
                      placeholder="e.g. admin@school.com or username" 
                      value={username}
                      required
                  ...
                  >
                    {isAnimating ? (
                      ...
                      <>Sign In <ArrowRight className="w-4 h-4 opacity-70 group-hover:translate-x-1 group-hover:opacity-100 transition-all" /></>
                    )}
                  </button>
                </form>
              </motion.div>
