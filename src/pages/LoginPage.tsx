...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // The auth state listener in AuthContext handles redirect to the dashboard
    } catch (error: any) {
      console.error("Google login error:", error);
      setErrorMessage(error.message || 'Google login failed. Please ensure popups are permitted.');
    } finally {
            ...
            {!selectedRole ? (
              ...
              >
                ...
                <form onSubmit={handleAuth} className="space-y-6">
                  ...
                  {/* Google Authenticate Alternative */}
                  ...
                  <button 
                    ...
                    className="w-full bg-white text-slate-700 border border-slate-200 font-bold py-3.5 rounded-xl hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm hover:shadow-md cursor-pointer text-sm"
                  >
